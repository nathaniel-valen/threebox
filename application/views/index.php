            ...
            <div class="container-fluid">
                <div>
                    ...
                    <div class="container-movie-card">
                        ...
                        <div class="movie-card">
                            <img src="<?= base_url('assets/img/film/') . $f['gambar']; ?>" class="card-img-top" alt="<?= $f['judul']; ?>" alt="Nama Film">
                ...
                <div>
                    ...
                    <div class="container-movie-card">
                        ...
                        <div class="movie-card">
                            <img src="<?= base_url('assets/img/film/') . $c['gambar']; ?>" class="card-img-top" alt="<?= $c['judul']; ?>" alt="Nama Film">
                            <div class="movie-details">
            ...
            <br><br>
            	<div>
            		...
            		<div>
            			<table class="table table-hover mx-5 my-5">
            				<thead>
            					<tr>
            						<th scope="col">No</th>
